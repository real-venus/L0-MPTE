...
contract MRPTTokenTest is Test {
    ...
    function test_vest_peoriod() public {
        ...
        assertEq(mrptToken.balanceOf(ecoSystem), 900e24 * 0.2 / 20 - 900e24 * 0.2 / 20 * 0.005);
    ...
    function test_transferFee() public {
        ...
        assertEq(mrptToken.balanceOf(bob), 995e15);
        ...
        assertEq(mrptToken.balanceOf(bob), 199e16);
    }
